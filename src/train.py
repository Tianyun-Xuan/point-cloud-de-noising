...
if __name__ == "__main__":
    ...
    batch_size = 4
    # 创建训练、验证和测试数据加载器
    train_loader = create_dataloader('data/5/npy', batch_size)
    val_loader = create_dataloader('data/5/npy', batch_size)
    test_loader = create_dataloader('data/5/npy', batch_size)
